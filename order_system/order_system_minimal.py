"""
Minimal Order System - Automatic Amazon & Instacart Orders
A clean, focused implementation for testing automatic order placement
"""
...
class OrderSystem:
    """Minimal order system with automatic Amazon/Instacart order placement"""
    
    def __init__(self):
        self.orders: Dict[str, Order] = {}
        self.state_tax_rates = {
            "CA": 0.0725, "NY": 0.0800, "TX": 0.0625, 
            "FL": 0.0600, "WA": 0.0650
        }
    ...
    async def _place_vendor_order(self, order: Order, product: Product) -> Dict:
        """Place order with vendor (Amazon, Instacart, Walmart)"""
    ...
    def get_user_orders(self, user_id: str, status: Optional[OrderStatus] = None, limit: int = 50) -> List[Order]:
...
# Create global order system instance
...
def get_user_orders(user_id: str, status: Optional[OrderStatus] = None, limit: int = 50) -> List[Order]:
    """Get orders for a specific user"""
